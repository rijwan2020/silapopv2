...
use App\Repositories\ProduktivitasRepository;
use Illuminate\Http\Request;

class ProduktivitasController extends BaseController
{
    public function __construct(ProduktivitasRepository $repo)
    {
        $this->repo = $repo;
    }
