...
class UpdateLuasTambahTanamTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('luas_tambah_tanam', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
            ...
            $table->bigInteger('data_luas_id')->default(0);
        });
    }
