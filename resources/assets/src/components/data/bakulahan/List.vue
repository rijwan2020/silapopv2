<template>
    <div>
		...
		<div class="row pt-3 text-center">
			<div class="col-md-12">
				<b-card class="mb-4">
					<p class="card-text">Total Luas Baku Lahan</p>
					<h4 class="card-title">{{ data.total_luas }} Ha</h4>
				</b-card>
			</div>
		</div>
        ...
        <b-card no-body class="px-3 py-2 mt-2">
            <div class="row">
                ...
                <div class="col-md-7 px-0 text-right">
                    <b-btn
                        variant="success"
                        v-b-tooltip.hover
                        title="Download Data"
		...
		<b-modal
            ...
            <!-- Luas -->
			<b-form-row>
				<b-form-group label="Luas Baku Lahan" class="col">
                    <b-input-group>
                        <b-input
                            placeholder="Luas"
                            v-model="saveData.luas_baku_lahan"
                        />
...
export default {
    ...
    data: () => ({
		...
		fields: [
			...
			{ key: "luas_baku_lahan", label:"Luas [Ha]", sortable: false, tdClass: "align-middle", thClass: "text-nowrap align-middle text-center"  },
    ...
    methods:{
        ...
        download(){
            ...
            axios({
                method: "post",
                url: this.publicUrl + "api/bakulahan/download",
                data: params
            }).catch((error) => {
        ...
        showModal(mode, i = null){
            ...
            if (mode == 'edit') {
                ...
                this.saveData = {
                    tahun: data.tahun,
                    jenis: data.jenis,
                    luas_baku_lahan: data.luas_baku_lahan,
        ...
        save() {
            ...
            axios({
                method: "post",
                url: this.publicUrl + "api/bakulahan",
                data: this.saveData
            })
                .then((response) => {
        ...
        update(){
            ...
            axios({
                method: "put",
                url: this.publicUrl + "api/bakulahan/" + this.id,
                data: this.saveData
            })
                .then((response) => {
                    if(this.fileAttachment != null){
        ...
        uploadFile(){
            ...
            axios.post(
                this.publicUrl + "api/bakulahan/file",
                formData,
                {
                    headers: {
        ...
        validate() {
            ...
            if (this.saveData.luas_baku_lahan <= 0) {
                this.notif("danger", "Error", "Luas baku lahan harus lebih besar dari 0.");
                return false;
            }
        ...
        confirmDelete() {
            ...
            axios({
                ...
                .then((response) => {
                    this.notif("success", "Success", "Data baku lahan berhasil dihapus.");
        ...
        goToDetail(i){
            ...
            this.$router.push({ name: "bakulahanDetail", params: {id: data.id} });
        },
		...
		loadAcl(){
			if (this.user) {
				if (this.user.level != 0) {
					...
					if (data_rule.rule.find(o => o.name === 'baku_lahan_add')) {	
						this.hasAccess.add = data_rule.rule.find(o => o.name === 'baku_lahan_add').active
					}
					if (data_rule.rule.find(o => o.name === 'baku_lahan_edit')) {	
						this.hasAccess.edit = data_rule.rule.find(o => o.name === 'baku_lahan_edit').active
					}
					if (data_rule.rule.find(o => o.name === 'baku_lahan_delete')) {	
						this.hasAccess.delete = data_rule.rule.find(o => o.name === 'baku_lahan_delete').active
					}
					if (data_rule.rule.find(o => o.name === 'baku_lahan_ver_kota')) {	
						this.hasAccess.verkota = data_rule.rule.find(o => o.name === 'baku_lahan_ver_kota').active
					}
					if (data_rule.rule.find(o => o.name === 'baku_lahan_ver_kec')) {	
						this.hasAccess.verkec = data_rule.rule.find(o => o.name === 'baku_lahan_ver_kec').active
					}
					if (data_rule.rule.find(o => o.name === 'rencana_realisasi')) {	
						this.hasAccess.detail = data_rule.rule.find(o => o.name === 'rencana_realisasi').active
					}
				}else{
					this.hasAccess = {
						add: true,
        ...
        verifikasi(i, tingkat, val){
            ...
            axios({
                method: "post",
                url: this.publicUrl + "api/bakulahan/verifikasi/" + data.id,
                data: saveData
            })
                .then((response) => {
        ...
        processVrf(){
            ...
            axios({
                method: "post",
                url: this.publicUrl + "api/bakulahan/vrf_all",
                data: params
            })
            .then((response) => {
