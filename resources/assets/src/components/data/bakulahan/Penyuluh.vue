...
export default {
    ...
    data: () => ({
		...
		fields: [
			...
			{ key: "bakulahan", label:"Luas Baku Lahan [Ha]", sortable: false, tdClass: "align-middle", thClass: "text-nowrap align-middle text-center"  },
			{
				key: "actions",
				label: "Action",
    ...
    methods:{
        goToDetail(i){
            ...
            this.$router.push({ name: "bakulahanList", params: param });
        },
        loadData(){
			this.isBusy = true;
