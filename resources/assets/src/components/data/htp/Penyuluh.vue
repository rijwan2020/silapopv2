        ...
        <div class="d-flex justify-content-between align-items-center w-100 mb-0 border-bottom">
            <div class="d-flex align-items-center">
                <h5 class="m-1 d-inline-block text-nowrap font-weight-normal">
                    Harga Tingkat Petani / Wilayah Kerja
                </h5>
            </div>
        </div>
...
export default {
    ...
    data: () => ({
		...
		fields: [
			...
			{ key: "htp", label:"Harga Rata-Rata [Rp/Kg]", sortable: false, tdClass: "align-middle", thClass: "text-nowrap align-middle text-center"  },
			{
				key: "actions",
				label: "Action",
    ...
    methods:{
        goToDetail(i){
            ...
            this.$router.push({ name: "htpList", params: param });
        },
        loadData(){
			this.isBusy = true;
