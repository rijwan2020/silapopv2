...
export default {
    ...
    data: () => ({
		...
		fields: [
			...
			{ key: "jumlah_alsin", label:"Jumlah Alsin", sortable: false, tdClass: "align-middle", thClass: "text-nowrap align-middle text-center"  },
			{
				key: "actions",
				label: "Action",
    ...
    methods:{
        goToDetail(i){
            ...
            this.$router.push({ name: "opsinList", params: param });
        },
        loadData(){
			this.isBusy = true;
