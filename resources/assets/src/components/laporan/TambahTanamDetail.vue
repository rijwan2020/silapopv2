    ...
    <div>
		...
		<b-card no-body>
            <div class="text-center">
                <h4 class="mt-3 mb-1"><b>Laporan Tambah Tanam {{ listBulan[bulan] }} {{ tahun }}</b></h4>
...
<script>
export default {
	name: 'laporan-tambah-tanam-detail',
	metaInfo: {
    ...
    methods:{
        loadData(){
			...
			axios
				.get(this.publicUrl + "api/laporan/tambah_tanam/detail", {
					params: params
				})
				.then((response) => {
					// handle success
        ...
        download(){
            ...
            axios({
                method: "post",
                url: this.publicUrl + "api/laporan/tambah_tanam/detail/download",
                data: param
            }).catch((error) => {
