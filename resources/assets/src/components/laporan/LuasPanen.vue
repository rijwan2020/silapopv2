    ...
    <div>
		...
		<b-card no-body>
            ...
            <div class="text-center">
                <h4 class="mt-3 mb-1"><b>Laporan Luas Panen Tahun {{ tahun }}</b></h4>
...
export default {
    ...
    methods:{
        loadData(){
			...
			axios
				.get(this.publicUrl + "api/laporan/luas_panen", {
					params: params
				})
				.then((response) => {
					// handle success
        ...
        toDetail(i){
            ...
            this.$router.push({name: 'laporan_luas_panen_detail', params: params});
        },
        ...
        download(){
            ...
            axios({
                method: "post",
                url: this.publicUrl + "api/laporan/luas_panen/download",
                data: param
            }).catch((error) => {
