    ...
    <div>
		...
		<b-card no-body>
            ...
            <div class="text-center">
                <h4 class="mt-3 mb-1"><b>Laporan Realisasi Alsin Tahun {{ tahun }}</b></h4>
                ...
                <template v-else>
                    <table class="table table-striped table-bordered">
                        <thead class="text-center">
                            ...
                            <tr>
                                <th v-for="(bulan, i) in listBulan" :key="i" colspan="2">
                                    <span @click="toDetail(i + 1)" style="cursor: pointer">{{ bulan }}</span>
                                </th>
                            </tr>
                            <tr>
                                <template v-for="i in 26">
...
export default {
    ...
    methods:{
        loadData(){
			...
			axios
				.get(this.publicUrl + "api/laporan/opsin/realisasi", {
					params: params
				})
				.then((response) => {
					// handle success
        ...
        toDetail(i){
            ...
            this.$router.push({name: 'realisasi_opsin_detail', params: params});
        },
        ...
        download(){
            ...
            axios({
                method: "post",
                url: this.publicUrl + "api/laporan/opsin/realisasi/download",
                data: param
            }).catch((error) => {
