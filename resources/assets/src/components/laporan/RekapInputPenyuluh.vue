    ...
    <div>
		...
		<b-card no-body>
            ...
            <div class="text-center">
                <h4 class="mt-3 mb-1"><b>Laporan Rekap Input Penyuluh</b></h4>
                <h5>{{ tanggal | formatTanggal }}</h5>
            </div>
			...
			<div class="table-responsive">
				...
				>
                    ...
                    <template v-slot:cell(bakulahan)="data">
						<b-badge variant="success" v-if="data.item.bakulahan">
                            Sudah
                        </b-badge>
                    ...
                    <template v-slot:cell(rencana_tanam)="data">
						<b-badge variant="success" v-if="data.item.rencana_tanam">
                            Sudah
                        </b-badge>
                        <b-badge variant="danger" v-else>
                            Belum
                    ...
                    <template v-slot:cell(realisasi_tanam)="data">
						<b-badge variant="success" v-if="data.item.realisasi_tanam">
                            Sudah
                        </b-badge>
                        <b-badge variant="danger" v-else>
                            Belum
                    ...
                    <template v-slot:cell(luas_tanam)="data">
						<b-badge variant="success" v-if="data.item.luas_tanam">
                            Sudah
                        </b-badge>
                        <b-badge variant="danger" v-else>
                            Belum
                    ...
                    <template v-slot:cell(tambah_tanam)="data">
						<b-badge variant="success" v-if="data.item.tambah_tanam">
                            Sudah
                        </b-badge>
                        <b-badge variant="danger" v-else>
                            Belum
                    ...
                    <template v-slot:cell(luas_panen)="data">
						<b-badge variant="success" v-if="data.item.luas_panen">
                            Sudah
                        </b-badge>
                        <b-badge variant="danger" v-else>
                            Belum
                    ...
                    <template v-slot:cell(produksi)="data">
						<b-badge variant="success" v-if="data.item.produksi">
                            Sudah
                        </b-badge>
                        <b-badge variant="danger" v-else>
                            Belum
                    ...
                    <template v-slot:cell(htp)="data">
						<b-badge variant="success" v-if="data.item.htp">
                            Sudah
                        </b-badge>
                        <b-badge variant="danger" v-else>
                            Belum
                    ...
                    <template v-slot:cell(opsin)="data">
						<b-badge variant="success" v-if="data.item.opsin">
                            Sudah
                        </b-badge>
                        <b-badge variant="danger" v-else>
                            Belum
                    ...
                    <template v-slot:cell(ltt_ltp)="data">
						<b-badge variant="success" v-if="data.item.ltt_ltp">
                            Sudah
                        </b-badge>
                        <b-badge variant="danger" v-else>
                            Belum
                    ...
                    <template v-slot:cell(alsin)="data">
						<b-badge variant="success" v-if="data.item.alsin">
                            Sudah
                        </b-badge>
                        <b-badge variant="danger" v-else>
                            Belum
        ...
        <b-card no-body class="px-3 py-2 mt-2">
            <div class="row">
                ...
                <div class="col-md-3 px-0">
                    <b-form-group label="Tanggal" class="w-auto m-1">
                        <b-datepicker 
                            size="md" 
                ...
                <div class="col-md-3 px-0 text-right">
                    <b-btn
                        ...
                        @click="download()"
                        class="mt-3"
                        v-if="hasAccess.laporan_rekap_input_penyuluh_download"
                    >
...
<script>
export default {
	name: 'laporan-rekap-input-penyuluh',
	metaInfo: {
		title: 'Laporan Rekap Input Penyuluh'
    },
    data: () => ({
		// Options
		sortBy: "id",
        ...
        fields: [
            ...
            {key: 'bakulahan', label:"Baku Lahan", sortable: false, tdClass: "align-middle", thClass: "align-middle text-center"},
            {key: 'rencana_tanam', label:"Rencana Tanam", sortable: false, tdClass: "align-middle", thClass: "align-middle text-center"},
            {key: 'realisasi_tanam', label:"Realisasi Tanam", sortable: false, tdClass: "align-middle", thClass: "align-middle text-center"},
            {key: 'luas_tanam', label:"Luas Tanam", sortable: false, tdClass: "align-middle", thClass: "align-middle text-center"},
            {key: 'tambah_tanam', label:"Tambah Tanam", sortable: false, tdClass: "align-middle", thClass: "align-middle text-center"},
            {key: 'luas_panen', label:"Luas Panen", sortable: false, tdClass: "align-middle", thClass: "align-middle text-center"},
            {key: 'produksi', label:"Produksi", sortable: false, tdClass: "align-middle", thClass: "align-middle text-center"},
            {key: 'htp', label:"Htp", sortable: false, tdClass: "align-middle", thClass: "align-middle text-center"},
            {key: 'opsin', label:"Opsin", sortable: false, tdClass: "align-middle", thClass: "align-middle text-center"},
            {key: 'ltt_ltp', label:"Ltt/Ltp", sortable: false, tdClass: "align-middle", thClass: "align-middle text-center"},
            {key: 'alsin', label:"Alsin", sortable: false, tdClass: "align-middle", thClass: "align-middle text-center"},
        ]
	}),
    filters:{
        formatTanggal(value){
            ...
            var tanggal = value.getDate() + ' ' + bulan[value.getMonth()] + ' ' + value.getFullYear()
            return tanggal
        },
    },
	computed: {
    ...
    methods:{
        loadData(){
			...
			axios
				.get(this.publicUrl + "api/laporan/rekap_input_penyuluh", {
					params: params
				})
				.then((response) => {
					// handle success
        ...
        download(){
            ...
            axios({
                method: "post",
                url: this.publicUrl + "api/laporan/rekap_input_penyuluh/download",
                data: params
            }).catch((error) => {
		...
		loadAcl(){
			if (this.user) {
				if (this.user.level != 0) {
					this.hasAccess = {
						laporan_rekap_input_penyuluh_download: false,
					}
					let data_rule = this.listLevel.find(o => o.level === this.user.level)
					
					if (data_rule.rule.find(o => o.name === 'laporan_rekap_input_penyuluh_download')) {	
						this.hasAccess.laporan_rekap_input_penyuluh_download = data_rule.rule.find(o => o.name === 'laporan_rekap_input_penyuluh_download').active
					}
				}else{
					this.hasAccess = {
						laporan_rekap_input_penyuluh_download: true
					}
				}
			}
        },
	...
	created() {
        this.tanggal = new Date().toJSON().slice(0,10).replace(/-/g,'-')
		this.loadLevel();
        this.loadData();
        this.loadListKota();
	}
